    ...
    <div className="pt-24 pb-16">
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div data-aos="fade-right">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                practical, industry-relevant IT education that empowers
                individuals to build successful careers and contribute to
            ...
            <div data-aos="fade-left">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                To become Pakistan's leading IT education platform, recognized
                for producing highly skilled professionals who drive innovation
                and technological advancement in the country.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                We envision a future where every Pakistani has access to quality
                technical education and the opportunity to thrive in the digital
                economy.
              </p>
            </div>
          </div>
          ...
          {/* Story */}
          <div
            className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 md:p-12 mb-16"
            data-aos="fade-up"
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  Bano Qabil is a nationwide initiative of Jamaat-e-Islami
                  Pakistan, established to provide free, high-quality IT
                  education to talented youth across Pakistan.
                </p>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  The program operates across multiple cities nationwide, aiming
                  to equip students from diverse backgrounds with
                  industry-relevant technical skills and practical knowledge.
                </p>
                <p className="text-gray-700 dark:text-gray-300">
                  Today, Bano Qabil stands as a countrywide skills-development
                  movement, empowering thousands of students while continuously
                  adapting to the evolving demands of Pakistan’s IT industry.
                </p>
              </div>
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-4 bg-white dark:bg-gray-900 p-4 rounded-xl shadow-lg max-w-xs">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    Students Transformed Since 2015
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {values.map((value, index) => (
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-full bg-${value.color}-100 dark:bg-${value.color}-900/20 flex items-center justify-center mx-auto mb-4`}
                  >
                    <div
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="container-custom text-center">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto mb-8">
            Be part of Pakistan's digital revolution. Together, we can build a
